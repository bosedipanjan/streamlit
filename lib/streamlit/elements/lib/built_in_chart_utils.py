...
def generate_chart(
    ...
    # Handle horizontal bar chart, which switch the x and y encodings:
    if horizontal:
        x_encoding = _get_y_encoding(df, y_column, y_from_user)
        y_encoding = _get_x_encoding(df, x_column, x_from_user, chart_type)
    else:
        x_encoding = _get_x_encoding(df, x_column, x_from_user, chart_type)
        y_encoding = _get_y_encoding(df, y_column, y_from_user)
